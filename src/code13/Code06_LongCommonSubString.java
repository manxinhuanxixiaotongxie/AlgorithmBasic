...
public class Code06_LongCommonSubString {
    ...
    public static void main(String[] args) {
        System.out.println(new Code06_LongCommonSubString().longCommonSubString("ABD", "ACD"));
    }

    public int longCommonSubString(String text1, String text2) {
